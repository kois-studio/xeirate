...
The public landing lives at `/`; the operational workspace lives at `/app`. The static Astro website keeps schedule data in the user’s browser. It is not a native iPhone application, does not require an account, and does not send staff data to a server.
